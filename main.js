...
const computeRefWidth = function () {
    ...
    setTimeout(() => {
        ...
        targetAutoCompleteList = $('#ui-id-1');
        $(targetAutoCompleteList).addClass('search-autocomplete-ul');

    }, 500);
}

const configureAutoComplete = function () {
    ...
    $( "#tags" ).autocomplete(autoCompleteOptions);
}
const appendActionsToUAutoCompleteUl = function () {
    let actions = `
        <div class="actionsul">
            <button class="action-google-search buttonaction" > Google Search </button>
            <button class="action-feeling-lucky buttonaction" > I'm Feeling Lucky </button>
        </div>`
    $('#ui-id-1').append(actions);
}
